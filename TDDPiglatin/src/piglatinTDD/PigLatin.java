...
class PigLatin {
    ...
    public Boolean isEndsWithSpace(String phrase) {
        ...
        return phrase.charAt(lastChar - 1) == ' ';
    ...
    private void setPhrase(String string)
    {
        this.phrase = string;
    }
     ...
     */
    private boolean isAllTheInputUpperCase(String phrase)
    {
     ...
     */
    private String converStringtInTitleCase(String phrase)
    {
     ...
     */
    private Boolean isTitleCase(String phrase)
    {
