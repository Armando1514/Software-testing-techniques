 ...
 * follows:
 * 
 * // Create a new game Game game = new Game("name1", "name2");
 *
 * // Get the name of the two players String playerName1 =
 * game.getPlayerName1(); String playerName2 = game.getPlayerName2();
 *
 * // Update the game by incrementing the score of either the first or second
 * player game.incrementPlayerScore(playerName1);
 * game.incrementPlayerScore(playerName2);
 *
 * // Get the status of the game String status = game.getGameStatus();
 * 
 */
public class Game {
